    ...
    // 是否升级送矿机
...

   	{
		...
		if($a111['ksed']>=10000){
					...
					}else if($a111['ksed']>=5600){

						$nowLevel = 6;

			

					}else if($a111['ksed']>=2800){

		

						$nowLevel = 5;

					}else if($a111['ksed']>=1200){

						$nowLevel = 4;

					}else if($a111['ksed']>=600){

						$nowLevel = 3;

					}else if($a111['ksed']>=300){

						$nowLevel = 2;

					}else if($a111['ksed']>=50){
